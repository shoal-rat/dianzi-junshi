...
The cross-platform release workflow is dispatched manually from GitHub Actions at a chosen tag and creates a draft GitHub Release with Windows, macOS, and Linux installers. See [desktop release instructions](docs/发布桌面安装包.md) and the [v5.6.0 notes](docs/releases/v5.6.0.md).
