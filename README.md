...
直球低敏、慢热低展示、审美仪式感、社交活跃、高选择权玩家型，它会按聊天和朋友圈证据分型，再给拉扯强度：该清楚就清楚，该留钩子就留钩子，该降频观察就降频观察。追男生和追女生的常见脚本也会校准，但不硬套性别。

**对方耍套路，第一时间帮你看穿**

![识破对方画饼、忽冷忽热，给你不接招和拿回主动两种走法](assets/demo-tactics.svg)

忽冷忽热、画饼、只撩不约、欲擒故纵，这些套路它都认得，会直接告诉你这是套路还是正常拉扯，再给你接得住的走法：不接招，或者收回主动。它也看新的平台化信号：模板化高情绪价值、评论区暧昧、朋友圈定向投喂、多线排班、节日借势。该你拉扯的时候，它会给一个策略框：多久回、要不要停一停、下一步看 ta 补不补动作、以及海王/海后置信度。

**反海王/海后模式：识别到就开始打擂台**

海王/海后置信度一旦偏高，它不会继续让你无脑投喂情绪价值，而是切到拉扯打擂台：降频观察、轻推回球、换时段测试、专属细节测试、邀约兑现测试。对方只给漂亮话，就不加码；对方给真实行动，才接着推进。
